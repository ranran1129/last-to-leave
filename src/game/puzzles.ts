...
export const PUZZLES: PuzzleDef[] = [
  ...
  },
  {
    ...
    answer: '↑ → ↑ → ↑ ←（としくまぬいぐるみキーホルダー→ポーチ→缶バッジケース→個別推しメンペンライト Ver.2→トートバッグ→コーチジャケット→軍団Tシャツ）',
  },
  {
    ...
    hints: [
      ...
      '写真でわかる特徴（花の色と高さ）と、いま見える特徴（花器の形と札の跡）は別のもの。両方に共通する手がかりでつなごう。',
      '入口は写真の左側。オレンジ色の2基は、色だけでは決まらない。高さ → 花器に残った札の跡の形 → 札の形、の順にたどれば区別できる。',
    ],
    answer: '1 空色（日向坂46を応援するおひさま有志）→ 2 オレンジ・丸い花器（福岡のおひさま一同）→ 3 黄色（二期生を見守る会）→ 4 白（九州遠征組より）→ 5 オレンジ・四角い花器（ひより推し有志一同）',
  },
  {
