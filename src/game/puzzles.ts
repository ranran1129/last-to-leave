...
export const PUZZLES: PuzzleDef[] = [
  ...
  },
  {
    ...
    hints: [
      'どの入力に音が来ているかは、卓のメーターがそのまま教えてくれている。流す先については、スタッフが書き残したメモがある。',
      '搬入口のスピーカーについてのメモは、楽屋前の廊下の「撤収ボード」にある。客席とコンコースは通常どおり、と書かれている。',
  ...
  },
  {
    ...
    hints: [
      '盤に貼られた注意書きを読もう。機材を運び出したあとの「空の回路」に送電すると、盤ごと落ちてしまう。つまり、いま館内に残っている機材の系統だけを入れればいい。',
      '何が運び出されたかは、搬入口の積み込みチェック表でわかる。ただし機材は「テープの色」でしか書かれていない。色が場所のどこを指すかは、ステージの前に並んだケースに書いてある。',
      '赤＝上手、青＝下手、黄＝中央。積み込み済みを消すと、残る機材は〈照明リグ（上手）〉だけ。そこにチェック表へ載らない常設設備〈音響・照明卓（FOH）〉と〈搬入口シャッター〉を足して、ちょうど3系統になる。',
    ],
